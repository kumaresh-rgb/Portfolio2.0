...
const gamingSetup = {
  laptop: {
    ...
    specs:
      "Intel Core i5 10th Gen 10300H | 16GB RAM | 1TB SSD | GTX 1650 4GB | 120Hz Display",
...
const pcGames = [
  {
    ...
    img: asset("GTA 5 currently playing.jpg"),
    tags: ["Adventure", "Open World"],
  },
  {
    name: "Clair Obscur: Expedition 33",
    status: "Completed",
    img: asset("Clair Obscur Expedition 33.png"),
    tags: ["RPG", "Turn-Based"],
  },
  {
    name: "Apex Legends",
    status: "Completed",
    img: asset("Apex_legends_cover.jpg"),
  ...
  },
  {
    ...
    status: "Completed",
    img: asset("rdr2.png"),
    tags: ["Cinematic", "Open World"],
  },
  {
    name: "Resident Evil 4 Remake",
    status: "Completed",
    img: asset("Resident_Evil_4_remake_cover_art.jpg"),
    tags: ["Horror", "Action"],
  },
  {
    name: "God of War Ragnarök",
    status: "Completed",
    img: asset("GODOFWAR RAGNORK.png"),
    tags: ["Action", "Adventure"],
  },
  {
    name: "God Hand",
    status: "Completed",
    img: asset("god-hand-.webp"),
    tags: ["Action", "Beat 'em up"],
  },
  {
    name: "God of War 4",
    status: "Completed",
    img: asset("godofwar 4.png"),
    tags: ["Masterpiece"],
  },
  {
    name: "God of War 1",
    status: "Completed",
    img: asset("godof war 1.png"),
    tags: ["Classic"],
  },
  {
    name: "God of War 2",
    status: "Completed",
    img: asset("godof war 2.png"),
    tags: ["Classic"],
  },
  {
    name: "God of War 3 Remastered",
    status: "Completed",
    img: asset("godwar 3.png"),
    tags: ["Cinematic"],
  },
];
...
const mobileGames = [
  {
    name: "BGMI",
    info: "ID: 5473199655 | Lvl 75",
    status: "Currently Playing Since 2019",
    img: asset("pubg.png"),
  },
  {
    name: "GOW: Ghost of Sparta",
    info: "PPSSPP Emulator",
    status: "Completed",
    img: asset("GHOSTOFSPARATA.webp"),
  },
  {
    name: "Mortal Kombat",
    info: "PPSSPP Emulator",
    status: "Completed",
    img: asset("Mortal KOMbat.jpg"),
  },
  {
    name: "GTA San Andreas",
    info: "Mobile Edition",
    status: "Completed",
    img: asset("gta san andreas.png"),
  },
  {
    name: "Clash of Clans",
    info: "Strategy",
    status: "Completed",
    img: asset("clashofclans.png"),
  },
  {
    name: "Candy Crush",
    info: "Casual",
    status: "Completed",
    img: asset("candycrush.jpg"),
  },
];
  ...
  return (
    <div className="min-h-screen text-white selection:bg-primary/30" style={{ background: "#0a0a0a", paddingBottom: 80 }}>
        ...
        <div className="relative z-10 text-center px-6">
          <motion.div
            ...
            <p className="text-on-surface-variant max-w-xl mx-auto text-lg">
              Exploring the convergence of high-performance engineering and
              visceral digital storytelling.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 -mt-20 relative z-20 space-y-32">
        {/* ── SECTION 1: THE GAMING RIG (Moved up) ── */}
        <section>
          <div className="flex items-center gap-4 mb-12">
            ...
            <div>
              ...
              <p className="text-primary text-sm font-mono tracking-widest uppercase">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <GlassCard className="lg:col-span-2 p-10 flex flex-col md:flex-row gap-12 items-center border-primary/20">
              ...
              <div className="w-full md:w-1/2">
                <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-md bg-primary/20 text-primary text-[10px] font-black uppercase tracking-widest">
                  Master Rig
                </div>
                <h3 className="text-3xl font-black text-white mb-4 leading-tight">
                  {gamingSetup.laptop.name}
                </h3>
            ...
            <div className="grid grid-cols-1 gap-4">
              {gamingSetup.peripherals.map((item, idx) => (
                <GlassCard
                  key={idx}
                  className="p-4 flex items-center gap-4 group hover:bg-white/[0.03] transition-colors">
          ...
          <div className="flex items-center justify-between mb-12">
            <div className="flex items-center gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-tertiary text-sm font-mono tracking-widest uppercase">
                  Adventures & Narrative Epics
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mobileGames.map((game, idx) => (
              <GlassCard
                key={idx}
                className="p-6 flex items-center gap-6 group hover:border-secondary/30 transition-all">
                ...
                <div className="flex-grow">
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="text-lg font-black text-white group-hover:text-secondary transition-colors">
                      {game.name}
                    </h4>
                    {/* Updated logic to highlight BGMI as active */}
                    {game.status.includes("Currently Playing") ? (
                  ...
                  <p
                    className={`text-[10px] font-black uppercase tracking-tighter mt-2 ${
                      game.status.includes("Currently Playing")
                        ? "text-green-500"
                        : "text-white/20"
                    }`}>
        ...
        {/* ── SECTION 4: OFFICE SETUP (Moved here) ── */}
      ...
      <footer className="py-20 text-center bg-black/40 border-t border-white/5">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <h5 className="text-white font-bold opacity-60 italic mb-2">
            "When the code stops, the play begins."
          </h5>
          <p className="text-sm text-on-surface-variant font-medium tracking-tight">
            © 2026 PLAYER ONE: MKUMARESH
          </p>
        </div>
      </footer>
    </div>
